          ...
          <div className="text-white flex-1">
            <div className="space-y-4">
              <div className="flex items-center gap-3 border-b border-gray-500 pb-3">
                ...
                <span className="text-sm">Los Santos County Sheriff's Department</span>
              </div>
              <div className="flex items-center gap-3 border-b border-gray-500 pb-3">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" />
                </svg>
                <span className="text-sm">211 W Temple St, Los Santos, SA 90012</span>
              </div>
              <div className="flex items-center gap-3 border-b border-gray-500 pb-3">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
                </svg>
                <span className="text-sm">(213) 229-1700</span>
              </div>
            </div>
